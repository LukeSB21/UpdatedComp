...
namespace LoginForm {
    ...
    public partial class DatabaseDataSet : global::System.Data.DataSet {
        ...
        public partial class employeeDataTable : global::System.Data.TypedTableBase<employeeRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public employeeRow AddemployeeRow(string firstName, string lastName, System.DateTime joinDate, System.DateTime dateOfBirth) {
...
namespace LoginForm.DatabaseDataSetTableAdapters {
    ...
    public partial class employeeTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[employee] ([firstName], [lastName], [joinDate], [dateOfBirth])" +
                " VALUES (@firstName, @lastName, @joinDate, @dateOfBirth);\r\nSELECT employeeId, fi" +
                "rstName, lastName, joinDate, dateOfBirth FROM employee WHERE (employeeId = SCOPE" +
                "_IDENTITY())";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[employee] SET [firstName] = @firstName, [lastName] = @lastName, [joinDate] = @joinDate, [dateOfBirth] = @dateOfBirth WHERE (([employeeId] = @Original_employeeId) AND ((@IsNull_firstName = 1 AND [firstName] IS NULL) OR ([firstName] = @Original_firstName)) AND ((@IsNull_lastName = 1 AND [lastName] IS NULL) OR ([lastName] = @Original_lastName)) AND ((@IsNull_joinDate = 1 AND [joinDate] IS NULL) OR ([joinDate] = @Original_joinDate)) AND ((@IsNull_dateOfBirth = 1 AND [dateOfBirth] IS NULL) OR ([dateOfBirth] = @Original_dateOfBirth)));
SELECT employeeId, firstName, lastName, joinDate, dateOfBirth FROM employee WHERE (employeeId = @employeeId)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT employeeId, firstName, lastName, joinDate, dateOfBirth FROM dbo.employee";
        ...
        public virtual int Delete(int Original_employeeId, string Original_firstName, string Original_lastName, global::System.Nullable<global::System.DateTime> Original_joinDate, global::System.Nullable<global::System.DateTime> Original_dateOfBirth) {
        ...
        public virtual int Insert(string firstName, string lastName, global::System.Nullable<global::System.DateTime> joinDate, global::System.Nullable<global::System.DateTime> dateOfBirth) {
            if ((firstName == null)) {
        ...
        public virtual int Update(string firstName, string lastName, global::System.Nullable<global::System.DateTime> joinDate, global::System.Nullable<global::System.DateTime> dateOfBirth, int Original_employeeId, string Original_firstName, string Original_lastName, global::System.Nullable<global::System.DateTime> Original_joinDate, global::System.Nullable<global::System.DateTime> Original_dateOfBirth, int employeeId) {
            if ((firstName == null)) {
            ...
            if ((Original_joinDate.HasValue == true)) {
                ...
                this.Adapter.UpdateCommand.Parameters[10].Value = ((System.DateTime)(Original_joinDate.Value));
            }
            else {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string firstName, string lastName, global::System.Nullable<global::System.DateTime> joinDate, global::System.Nullable<global::System.DateTime> dateOfBirth, int Original_employeeId, string Original_firstName, string Original_lastName, global::System.Nullable<global::System.DateTime> Original_joinDate, global::System.Nullable<global::System.DateTime> Original_dateOfBirth) {
            return this.Update(firstName, lastName, joinDate, dateOfBirth, Original_employeeId, Original_firstName, Original_lastName, Original_joinDate, Original_dateOfBirth, Original_employeeId);
        }
    }
